...
```bash
brew tap yetanotherchris/keepassview https://github.com/yetanotherchris/keepassview
brew install keepassview
```

**Scoop (Windows)**
```powershell
scoop bucket add keepassview https://github.com/yetanotherchris/keepassview
scoop install keepassview
```
